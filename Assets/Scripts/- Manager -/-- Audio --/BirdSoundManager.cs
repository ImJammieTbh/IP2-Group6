...
public class BirdSoundManager : MonoBehaviour
{
    ...
    public static BirdSoundManager instance; // Makes it easier to call in other scripts
    ...
    //SINGLE SFX
    public void PlayBirdSoundClip(AudioClip audioClip, Transform spawnTransform, float volume)
    {
        //Spawn game object
    ...
    //RANDOM SFX
    public void PlayRandomBirdSoundClip(AudioClip[] audioClip, Transform spawnTransform, float volume)
    {
        //Random SFX selector
